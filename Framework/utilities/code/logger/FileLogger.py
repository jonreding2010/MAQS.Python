from Framework.utilities.logging import ConsoleLogger, MessageType
...
class FileLogger(Logger):
    ...
    def __init__(self):
        ...
        self.DEFAULTLOGFOLDER = Path.gettempdir()
        # Initializes a new instance of the FileLogger class.
        self.DEFAULTLOGNAME = "FileLog.txt"
    ...
    def file_logger(self, append, logFolder, name, messageLevel):
        ...
        if (path.exists(filePath) and not append):
            try:
                ...
                console.logMessage(MessageType.ERROR, StringProcessor.safeFormatter("Failed to write to event log because: " + e.args)
