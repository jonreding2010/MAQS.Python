import os.path 
from os import path
from Framework.utilities.helper import ConfigSection, StringProcessor
...
class Config:
  ...
  def config(parameter_list):
    try:
        ...
        raise TimeoutError(StringProcessor.safeFormatter("Exception creating the xml configuration object from the file : " + e.args))
    ...
    def addGeneralTestSettingValues(configurations, overrideExisting):
        ...
        # @param overrideExisting True to override existing values, False otherwise
    def add_test_setting_values(configurations, section, overrideExisting):
    ...
    # @return The configuration value
    def get_general_value(key,defaultValue):
    ...
    # @param key     The key
    # @return The configuration value
    def get_value_for_section(section, key):
    ...
    # @return The configuration value
    def get_value_for_section(section, key, defaultValue):
    ...
    def get_value(key, defaultValue):
    ...
    # @return True if the key exists, false otherwise
    def does_key_exist(key, section):
        keyWithSection = section + "." + key;
    ...
    # @param key The key
    # @return True if the key exists, false otherwise
    def does_general_key_exist(key):
